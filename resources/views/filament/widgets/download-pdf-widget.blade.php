<div class="flex justify-end p-4 bg-white rounded-lg shadow">
    <a
        ...
        target="_blank"
        class="mx-auto filament-button filament-button-size-md inline-flex items-center justify-center py-2 px-2 gap-2 font-medium rounded-lg border transition-colors focus:outline-none focus:ring-offset-2 focus:ring-2 focus:ring-inset filament-page-button-action bg-primary-600 text-white hover:bg-primary-500 focus:bg-primary-700 focus:ring-offset-primary-700 focus:ring-white"
    >
